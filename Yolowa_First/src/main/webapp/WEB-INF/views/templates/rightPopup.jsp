...
$(document).ready(function() {
		...
		$.ajax({
			...
			success:function(data){
				...
				for(var i=0; i < data.length; i++){
					...
					listTxt += "<span class='fa fa-user-plus fa-2x'></span>";
					listTxt += "</div></li>";
				}
   ...
   //// 친구 리스트 & Message
      $("#tabBtn").click(function() {
         ...
         $.ajax({
            ...
            success:function(data){
               ...
               for(var i=0; i < data.length; i++){
                  friendsListTxt +="<li>";
                  friendsListTxt +="<img src=${pageContext.request.contextPath}/"+data[i].filePath +" alt="+data[i].id+">";
                  ...
                  friendsListTxt +="<span class='fa fa-user-times fa-2x'></span></a></div></li>";
                  //friendsListTxt +="<div class='dot'></div></li>";
               }
         ...
         $.ajax({
            ...
            success:function(data){
                ...
                for(var i=0;i<data.msgBox.length;i++){
                	var idVal = "${sessionScope.member.id}";
                    ...
                    msgTxt +="<time datetime='2009-11-13T20:00'>"+data.msgBox[i].mPostdate+"</time>  </div>";
                      ...
                      msgTxt +="<img src=${pageContext.request.contextPath}/${sessionScope.member.filePath} class='img-responsive' alt='user name'>";
                      msgTxt +="</div> </div>";
                	}
                	else{
      ...
      $("#chatBtn").click(function(){
    	  ...
    	  var sendId = "${sessionScope.member.id}";
...
<ul class="nav nav-tabs" >
   ...
   <li>
      <a data-toggle="tab" href="#right-menu-userRecommend">
         <span class="icon-people fa-2x" id="recommend"></span>
      </a>
   </li>
   <li>
      <a data-toggle="tab" href="#right-menu-friendRequest">
         <span class="icon-user-follow fa-2x" id="checkRequest"></span>
      </a>
   </li>
</ul>
...
<div class="tab-content">
   ...
   <div id="right-menu-user" class="tab-pane fade in active">
      ...
      <div class="col-md-12 chatbox" id ="msgContainer">
         ...
         <div class="chat-area" >
            <div class="chat-area-content" id="chatScroll">
               <div class="msg_container_base" id="msgContent">
               </div>
            </div>
         </div>
         <div class="user-list"  id="chatBox">
              <textarea id="chatTxt" placeholder="type your message here.."></textarea>
