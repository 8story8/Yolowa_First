		...
		<form id="writeFunding" action="writeFunding.do" method="post" enctype="multipart/form-data">
			<div class="box-v5 panel">
				...
				<table class="col-md-12 padding-0">
					<thead>
					<tr>
					<td colspan="2">제 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : <input type="text" name="fTitle" size="40px"></td>
					...
					<tr>
						...
						<td>목표인원 : <input type="text" name="fPeople" size="10px"></td>
						<td>목표포인트: <input type="text" name="fPoint" size="10px"></td>
					</tr>
					</thead>
					<tbody>
						<tr>
							<td colspan="3"><textarea id="bContent" name="bContent" class="col-md-12" style="height: 180px;"></textarea></td>
						</tr>
                  </tbody>
					<tr>
