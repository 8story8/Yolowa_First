...
<!-- funding -->
<div id="fundingForm">
		<form id="modifyFunding" action="modifyFunding.do?type=funding" method="post" enctype="multipart/form-data">
			<div class="box-v5 panel">
				<div class="panel-heading padding-0 bg-white border-none">
				<table class="col-md-12 padding-0">
					<thead>
					<tr>
					<td colspan="2">제 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목 : <input type="text" name="fTitle" size="40px" value="${mList.FTITLE}"></td>
					...
					<tr>
						...
						<td>목표인원 : <input type="text" name="fPeople" size="10px" value="${mList.FPEOPLE}"></td>
						<td>목표포인트: <input type="text" name="fPoint" size="10px" value="${mList.FPOINT}"></td>
					</tr>
					</thead>
					<tbody>
						<tr>
					...
					<tr>
                       ...
                       <!--  <input type="file" class="multi with-preview" id ="file" name="file" multiple/><br> -->
                    </tr>
                    <tr>
                    	<td>
...
function initMap() {
	...
	map = new google.maps.Map(document.getElementById('map'),{
		zoom : 17,
		center: {lat: 37.384974, lng: 127.123432}
