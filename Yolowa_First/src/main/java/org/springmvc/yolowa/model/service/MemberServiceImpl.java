...
public class MemberServiceImpl implements MemberService {
	...
	public Map<String, Object> myAllReceiveMsg(String myId, String curPage) {
		...
		System.out.println("메세지 수: " + getTotalMyMsg + "   " + nowPage);

		PagingBean page = new PagingBean(getTotalMyMsg, nowPage);
		System.out.println(page.getStartPageOfPageGroup());
		System.out.println(page.getEndPageOfPageGroup());
		List<MessageVO> myAllMsgList = dao.myAllReceiveMsg(myId, page);

		System.out.println(myAllMsgList.size() + " 리스트 수");
